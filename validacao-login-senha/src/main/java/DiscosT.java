...
public class DiscosT extends Componente {
    ...
    public void inserirReadWrite(Long time){
        ...
        for(DiscoT discoT: discosT){
            inserirCapturaComponente(discoT.calcularReadWrite(time), String.valueOf(TipoEnum.TAXA_TRANSFERENCIA), discoT.getIdDisco());
        }
